...
◊panel-main{
◊image-title["/ornaments/titles/Dr_Harms_Ink_Vomit.png" "Dr. Harms' Ink Vomit" 50]

◊center{◊Large{◊tt{A cure for all your ills!}}}
}
...
◊panel-main{
After nearly a 10-year hiatus, I started practicing drawing again after getting my PhD in fall
2022. I work mainly with fountain and dip pens. This is scientifically the best medium because (1)
it is binary: ink or not? (2) you cannot cheat (i.e. erase), and (3) fountain pens are the
greatest invention of any humanoid species.
}
...
If you want to see tons of great macro photography of bees, check out the
◊link["https://www.flickr.com/photos/usgsbiml"]{United States Geological Survey
bee inventory!}
}
...
Gifted to my friend Julie Messier.
...
I presented this poster at WoLA 2023 in MIT.

◊link["/wola_poster.html"]{Click here to see it bigger.}
}
...
This was supposed to be a quick warm-up sketch using a random internet image, but it got away from
me.
}
...
◊bf{Ink:} Iroshizuku Fuyu-Gaki, Iroshizuku Shin-Kai.
